                        ...
                        <ul class="w-full p-5 text-slate-900 dark:text-slate-50">
                            <li class="w-full">
                                ...
                                <Link
                                    ...
                                    <span class="w-6 h-6 mr-5 inline dark:hidden">
                                        <img src="/resources/home-light-mode.png" alt="home-icon" class="w-6 h-6" />
                                    </span>
                            ...
                            <li class="w-full">
                                <Link :href="route('admin.appointment.index')"
                                    ...
                                    id="sidebar-service">
                                <span class="w-6 h-6 mr-5 inline dark:hidden">
                                    <img src="/resources/appointment-light-mode.png" alt="home-icon" class="w-6 h-6" />
                                </span>
                                <span class="w-6 h-6 mr-5 hidden dark:inline">
                                    <img src="/resources/appointment-dark-mode.png" alt="home-icon" class="w-6 h-6" />
                                </span>
                                Appointment
                                </Link>
                            </li>
